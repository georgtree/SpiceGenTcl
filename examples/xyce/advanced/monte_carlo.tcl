...
set trace [calcDbMagVec [dget $data out]]
...
for {set i 0} {$i<$mcRuns} {incr i} {
    ...
    lappend traceListUni [calcDbMagVec [dget $data out]]
...
for {set i 0} {$i<$mcRuns} {incr i} {
    ...
    # get vout frequency curve
    lappend traceListNorm [calcDbMagVec [dget $data out]]
    # calculate bandwidths values
...
$chartCombined Render -outfile [file normalize [file join .. html_charts ${fbasename}_combined.html]] -height 800px\
        -width 1200px
