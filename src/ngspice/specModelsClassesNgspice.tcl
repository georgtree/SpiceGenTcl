...
###  RModel class 
    ...
    oo::class create RModel {
        ...
        constructor {name args} {
            ...
            next $name r [my argsPreprocess [list tc1 tc2 rsh defw narrow short tnom kf af wf lf ef r] {*}$args]
        }
    }
...
###  CModel class 
    ...
    oo::class create CModel {
        ...
        constructor {name args} {
            ...
            # ```
            # Synopsis: name ?-option value ...?
            next $name c [my argsPreprocess [list cap cj cjsw defw narrow short tc1 tc2 tnom di thick] {*}$args]
        }
    }
...
###  LModel class 
    ...
    oo::class create LModel {
        ...
        constructor {name args} {
            ...
            # ```
            # Synopsis: name ?-option value ...?
            next $name l [my argsPreprocess [list ind csect dia length tc1 tc2 tnom nt mu] {*}$args]
        }
    }    
###  VSwitchModel class 
    ...
    oo::class create VSwitchModel {
        ...
        constructor {name args} {
            ...
            # ```
            # Synopsis: name ?-option value ...?
            next $name sw [my argsPreprocess [list vt vh ron roff] {*}$args]
        }
    }
    ...
    oo::class create DiodeModel {
        ...
        constructor {name args} {
            ...
            set paramsNames [list level jws n rs bv ibv nbv ikr jtun jtunsw ntun xtitun keg isr nr\
                    ...
                    xti tlev tlevc ctp tcv is ikf cjo cjsw m vj\
                    tnom trs1 cta]
...
###  BjtGPModel class 
    ...
    oo::class create BjtGPModel {
        ...
        constructor {name type args} {
            ...
            set paramsNames [list subs is ibe ibc iss bf nf vaf ikf nkf ise ne br \
                    nr var ikr isc nc rb irb rbm re rc cje vje mje tf xtf \
                    vtf itf ptf cjc vjc mjc xcjc tr cjs vjs mjs xtb eg \
                    xti kf af fc tnom tlev tlevc tre1 tre2 trc1 trc2 trb1 trb2 \
