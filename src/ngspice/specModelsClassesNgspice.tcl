...
###  DiodeModel class 
    ...
    oo::class create DiodeModel {
        ...
        constructor {name args} {
            ...
            # ```
            # Synopsis: name ?-option value ...?
            set paramsNames {level jws n rs bv ibv nbv ikr jtun jtunsw ntun xtitun keg isr nr fc fcs mjsw php tt lm lp\
                                     wm wp xom xoi xm xp eg trs2 tm1 tm2 ttt1 ttt2 xti tlev tlevc ctp tcv is ikf cjo\
                                     cjsw m vj tnom trs1 cta}
...
###  BjtGPModel class 
    ...
    oo::class create BjtGPModel {
        ...
        constructor {name type args} {
            ...
            set paramsNames {subs is ibe ibc iss bf nf vaf ikf nkf ise ne br nr var ikr isc nc rb irb rbm re rc cje vje\
                                     mje tf xtf vtf itf ptf cjc vjc mjc xcjc tr cjs vjs mjs xtb eg xti kf af fc tnom\
                                     tlev tlevc tre1 tre2 trc1 trc2 trb1 trb2 trbm1 trbm2 tbf1 tbf2 tbr1 tbr2 tikf1\
                                     tikf2 tikr1 tikr2 tirb1 tirb2 tnc1 tnc2 tne1 tne2 tnf1 tnf2 tnr1 tnr2 tvaf1 tvaf2\
                                     tvar1 tvar2 ctc cte cts tvjc tvje titf1 titf2 ttf1 ttf2 ttr1 ttr2 tmje1 tmje2 tmjc1\
                                     tmjc2 rco gamma qco vg cn d}
