...
namespace eval ::SpiceGenTcl {
    namespace eval Ngspice::BasicDevices {
        namespace export Resistor R  Capacitor C Inductor L Coupling K SubcircuitInstance X SubcircuitInstanceAuto\
                XAuto VSwitch S CSwitch W VerilogA N
    }
...
namespace eval ::SpiceGenTcl::Ngspice::BasicDevices {
    ...
    oo::class create Inductor {
        ...
        constructor {args} {
            ...
            if {[dict exists $arguments l]} {
                ...
                } elseif {([llength $lVal]>1) && ([lindex $lVal 0] eq {-eq})} {
    ...
    oo::class create Coupling {
        ...
        constructor {args} {
            ...
            if {([llength $k]>1) && ([lindex $k 0] eq {-eq})} {
                ##nagelfar ignore {Found constant "k"}
                set k [list -poseq k [lindex $k 1]]
            } else {
                ##nagelfar ignore {Found constant "k"}
                set k [list -pos k $k]
            }
...
namespace eval ::SpiceGenTcl::Ngspice::Sources {
    ...
    oo::class create Vport {
        ...
        constructor {args} {
            ...
            set arguments [argparse -inline -pfirst -help {Creates object of class `Vport` that describes simple\
            ...
            dict for {paramName value} $argsOrdered {
                ...
                if {([llength $value]>1) && ([lindex $value 0] eq {-eq})} {
                    lappend params [list -poseq ${paramName}val [lindex $value 1]]
                } else {
                    lappend params [list -pos ${paramName}val $value]
                }
            }
            next v[dict get $arguments name] [my FormPinNodeList $arguments {np nm}] $params
        }
    }
    ...
    oo::class create BehaviouralSource {
        ...
        constructor {args} {
            ...
            next b[dict get $arguments name] [my FormPinNodeList $arguments {np nm}] $params
        }
    }
