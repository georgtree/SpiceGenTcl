...
dash=5
lock=1}
T {Low-pass chebyshev} 110 -220 0 0 0.2 0.2 {}
T {Low-pass
m-derived} 490 -220 0 0 0.15 0.15 {}
T {High-pass chebyshev} 850 -220 0 1 0.2 0.2 {}
T {High-pass 
...
name=L5}
T {@name} 420 -200 0 0 0.15 0.15 {name=L6}
...
N 290 -180 310 -180 {lab=#net2}
N 390 -180 410 -180 {lab=#net3}
N 470 -180 490 -180 {lab=#net4}
N 550 -180 660 -180 {lab=#net5}
N 720 -180 740 -180 {lab=#net6}
N 820 -180 840 -180 {lab=#net7}
N 920 -180 940 -180 {lab=#net8}
N 1020 -180 1040 -180 {lab=#net9}
N 570 -120 570 -110 {lab=#net10}
N 640 -120 640 -110 {lab=#net11}
N 1020 -50 1150 -50 {lab=#net12}
N 60 -90 60 -50 {lab=#net12}
N 1150 -90 1150 -50 {lab=#net12}
N 820 -90 820 -50 {lab=#net12}
N 390 -50 820 -50 {lab=#net12}
N 920 -90 920 -50 {lab=#net12}
N 820 -50 920 -50 {lab=#net12}
N 1020 -90 1020 -50 {lab=#net12}
N 920 -50 1020 -50 {lab=#net12}
N 390 -90 390 -50 {lab=#net12}
N 290 -50 390 -50 {lab=#net12}
N 290 -90 290 -50 {lab=#net12}
N 190 -50 290 -50 {lab=#net12}
N 190 -180 190 -150 {lab=#net1}
N 170 -180 190 -180 {lab=#net1}
N 190 -90 190 -50 {lab=#net12}
N 60 -50 190 -50 {lab=#net12}
N 290 -180 290 -150 {lab=#net2}
N 270 -180 290 -180 {lab=#net2}
N 390 -180 390 -150 {lab=#net3}
N 370 -180 390 -180 {lab=#net3}
N 820 -180 820 -150 {lab=#net7}
N 800 -180 820 -180 {lab=#net7}
N 920 -180 920 -150 {lab=#net8}
N 900 -180 920 -180 {lab=#net8}
N 1020 -180 1020 -150 {lab=#net9}
N 1000 -180 1020 -180 {lab=#net9}
N 60 -180 60 -150 {lab=#net13}
N 60 -180 110 -180 {lab=#net13}
N 1100 -180 1150 -180 {lab=#net14}
N 1150 -180 1150 -150 {lab=#net14}
...
hide_texts=true}
C {.sym_links/phys.elec.b_elem/inductor.sym} 440 -180 0 0 {name=L6 L=0.058u M=1 SCALE=1 DTEMP=0 TC1=0 TC2=0 IC=0
hide_texts=true}
